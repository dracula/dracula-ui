        ...
        return (
          <div key={variant}>
            <List
              ...
              color={'purple' as ListProps['color']}
            >
              ...
              <li className="drac-text drac-text-white">
                This is the tenth item (showing how numbers align and wrapping
                looks by default)
              </li>
            </List>
          </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      {Object.keys(listColors).map((color) => {
        return (
          <div key={color}>
            <List
              variant={'ordered' as ListProps['variant']}
              color={color as ListProps['color']}
            >
              <li className="drac-text drac-text-white">Blade</li>
              <li className="drac-text drac-text-white">Buffy</li>
              <li className="drac-text drac-text-white">Morbius</li>
