...
var Heading = function Heading(props) {
  var _props$size, _props$size2, _props$color, _props$spacing;
...
var textColors = /*#__PURE__*/mapValues(baseTextColors, function (className) {
  return className.replace('-bg-', '-text-');
});
/**
...
var Text = function Text(props) {
  ...
  return React.createElement("span", Object.assign({}, finalProps), props.children);
};
/**
...
var Paragraph = function Paragraph(props) {
  var _props$size2, _props$weight2, _props$color2, _props$spacing;

  var finalProps = _extends({}, props, {
    className: cx("drac-text", textSizes[(_props$size2 = props.size) != null ? _props$size2 : 'medium'], textWeights[(_props$weight2 = props.weight) != null ? _props$weight2 : 'normal'], textColors[(_props$color2 = props.color) != null ? _props$color2 : 'white'], spacingClasses((_props$spacing = props.spacing) != null ? _props$spacing : 'smallY'))
  });
...
var Box = function Box(props) {
  ...
  return React.createElement("div", Object.assign({}, finalProps));
};
Box.displayName = 'Box';
...
export { Avatar, AvatarBorderVariants, AvatarVariants, Badge, Box, Button, Card, Checkbox, Divider, Heading, Input, Paragraph, Radio, Select, Switch, Table, Tabs, Text, buttonSizes, buttonVariants, cardOrientations, cardVariants, checkboxColors, dividerColors, headingColors, headingSizes, inputColors, inputSizes, inputVariants, radioColors, selectColors, selectSizes, selectVariants, switchColors, tableColors, tableVariants, tabsColors, textColors, textSizes, textWeights };
