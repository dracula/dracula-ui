...
export async function getStaticProps() {
  return {
    props: {
      query: {
        title: 'Tooling',
        description: 'How to improve the developer experience in Visual Studio Code'
      }
    }
  }
}
              ...
              <Box>
                ...
                <Box my="lg">
                  ...
                  <List color="white" variant="ordered">
                    ...
                    <li className="drac-text drac-text-white">Now you should see the documentation</li>
                  </List>
                </Box>
                <Box my="lg">
                  <Heading size="heading-2">Autocomplete</Heading>
                  <Paragraph>In order to have autocomplete enabled on Visual Studio Code you must follow the steps above.</Paragraph>
                  <Paragraph>Once everything is installed, you should see snippets for HTML and JavaScript code. Here's an example with React:</Paragraph>
                  <img className={styles.image} src="/static/images/tooling-2.png" alt="Dracula UI autocomplete on VSCode" />
                </Box>
              </Box>
            </main>
          </Box>
